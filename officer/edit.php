...
$Nid = $_POST['Nid'];
$From = mysqli_real_escape_string($Nid,htmlspecialchars($_POST['From']));
$To = mysqli_real_escape_string($Nid,htmlspecialchars($_POST['To']));
$dateoftransfer = mysqli_real_escape_string($Nid,htmlspecialchars($_POST['dateoftransfer']));
...
// use code update db
mysqli_query($db,"UPDATE transfer SET File_Num='$Filenum', From_prison='$From', 
...
//user the second
$result = mysqli_query($db,"SELECT * FROM transfer WHERE id=$National_id")
or die(mysqli_error($db));
